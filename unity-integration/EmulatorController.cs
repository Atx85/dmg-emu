...
namespace DmgEmu.Frontend.Unity
{
    ...
    public class EmulatorController : MonoBehaviour
    {
        ...
        private void HandleInput()
        {
            ...
            emulator.bus.Joypad.SetButton(JoypadButton.Right, Input.GetKey(KeyCode.Right));
            emulator.bus.Joypad.SetButton(JoypadButton.Left, Input.GetKey(KeyCode.Left));
            emulator.bus.Joypad.SetButton(JoypadButton.Up, Input.GetKey(KeyCode.Up));
            emulator.bus.Joypad.SetButton(JoypadButton.Down, Input.GetKey(KeyCode.Down));
