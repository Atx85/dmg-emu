...
namespace GB {
    public class Bus {
        ...
        public byte WX { get { return 7; } } // default
        public byte WY { get { return 0; } } // default
...
public void DumpPpu()
{
    var fs = File.Create($"ppu_dump.bin");
    ...
    //bw.Write(OAMRam);
        ...
        public byte Read(int addr) {
            ...
            if (addr >= 0xA000 && addr <= 0xBFFF)
                return 0xFF; // or external RAM buffer
        ...
        public void Write(int addr, byte val) {
            ...
            if (addr >= 0x8000 && addr <= 0x9FFF) {
                if (PpuMode == 3) return; // block write
